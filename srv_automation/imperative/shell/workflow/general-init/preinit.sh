...
./srv_automation/imperative/shell/atomic/bootstrap/wait_for_cloud_init.sh

echo "--- Step 2/7: Update and upgrade system packages ---"
./srv_automation/imperative/shell/atomic/os/packages/update_and_upgrade.sh

echo "--- Step 3/7: Ensure scripts have executable permissions ---"
./srv_automation/imperative/shell/composite/bootstrap/set_script_runnable_permissions.sh

# Vault installation is a part of preinit because other scripts will need secrets.
echo "--- Step 4/7: Install Vault (skipping) ---"
#./srv_automation/imperative/shell/atomic/secrets/vault/install_vault.sh

echo "--- Step 5/7: Enable cgroups (requires reboot) ---"
./srv_automation/imperative/shell/atomic/os/system/enable_cgroups.sh

echo "--- Step 6/7: Install public SSH key(s) ---"
./srv_automation/imperative/shell/atomic/security/ssh/install_ssh_key_from_github.sh
