...
./srv_automation/imperative/shell/composite/storage/setup_external_drive.sh
# END: STORAGE
...
./srv_automation/imperative/shell/composite/k8s/storage/apply_music_storage.sh
# END: K8S STORAGE


# START: DEPLOY NAVIDROME
echo "--- Step 4/4: Deploying Navidrome application ---"
./srv_automation/imperative/shell/composite/k8s/services/deploy_navidrome.sh
