...
./srv_automation/imperative/shell/atomic/k8s/prerequisites/load_kernel_modules.sh

echo "--- Kubernetes Prerequisites: Applying sysctl settings ---"
./srv_automation/imperative/shell/atomic/k8s/prerequisites/set_sysctl_k8s.sh
