...
./srv_automation/imperative/shell/atomic/security/ids/install_falco.sh

echo "--- Setting up Falco to send email notifications ---"
./srv_automation/imperative/shell/atomic/security/ids/setup_falco_email_notifications.sh
