...
./srv_automation/imperative/shell/atomic/storage/mount/mount_external_drive.sh

echo "--- Step 2: Installing Samba ---"
./srv_automation/imperative/shell/atomic/storage/share/install_samba.sh

echo "--- Step 3: Exposing external drive over the network ---"
./srv_automation/imperative/shell/atomic/storage/share/expose_drive_over_network.sh
