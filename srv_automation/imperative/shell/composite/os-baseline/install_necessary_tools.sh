...
./srv_automation/imperative/shell/atomic/os/packages/install_dev_tools.sh

echo "--- Step 2: Network tools ---"
./srv_automation/imperative/shell/atomic/os/packages/install_network_tools.sh

echo "--- Step 3: Security tools ---"
./srv_automation/imperative/shell/atomic/os/packages/install_security_tools.sh

echo "--- Step 4: Installing and logging in to VPN of choice ---"
./srv_automation/imperative/shell/atomic/networking/vpn/install_vpn.sh
