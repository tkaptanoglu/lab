...
./srv_automation/imperative/shell/atomic/os/system/ensure_time_sync.sh

echo "--- Increasing file limits ---"
./srv_automation/imperative/shell/atomic/os/system/increase_file_limits.sh

echo "--- Enabling persistent journald ---"
./srv_automation/imperative/shell/atomic/os/system/enable_persistent_journald.sh
